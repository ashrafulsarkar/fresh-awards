...
function fawards_scripts() {
	...
	wp_enqueue_style( 'vuch-main-style', fawards_ROOT_CSS . '/style.css', [], fawards_VERSION );
	wp_enqueue_style( 'vuch-style', get_stylesheet_uri(), [], fawards_VERSION );

	wp_enqueue_script( 'hc-offcanvas-nav', fawards_ROOT_JS . '/hc-offcanvas-nav.js', ['jquery'], '6.1.5', true );
	wp_enqueue_script( 'vuch-script', fawards_ROOT_JS . '/main.js', ['jquery'], fawards_VERSION, true );
